...
Matrix& Matrix::operator =(const Matrix &other){
    std::cout << "Call Matrix operator = constructor" << std::endl;
    if(this != &other)
    {
        for(int i = 0 ; i < m_size ; i++)
        {
...
Matrix::Matrix(Matrix&& other){
    std::cout << "Call Matrix Move constructor" << std::endl;
    this->m_size = other.m_size;
...
Matrix& Matrix::operator = (Matrix&& other){
    std::cout << "Call Matrix Move operator assignment" << std::endl;
